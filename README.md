...
- **Customization:** You can customize the app the way you want it! (Title and color) 🖌️
...
2. **Configure the Webhook URL**: Open the script in a text editor and replace `set-your-webhook-here` with your Discord webhook URL. 🪝
3. Run the `DWN.bat` file.
